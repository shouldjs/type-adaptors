import { isGeneratorFunction, isIterator, hasOwnProperty, propertyIsEnumerable, merge } from 'should-util';
...
export function reduce(obj, f, initialValue) {
...
export function every(obj, f, context) {
  var res = true;
  forEach(obj, function(value, key) {
    if (!f.call(context, value, key, obj)) {
      res = false;
